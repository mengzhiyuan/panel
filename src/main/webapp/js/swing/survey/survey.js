...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/swing/survey/survey.js");
/******/ })
/************************************************************************/
/******/ ({
...
const survey_template = {
    ...
    sort: {
                    ...
                    <div class="item" v-if="correspond && config.exist && page === config.page_now">
                        ...
                        <div class="item-chest">
                            ...
                            <div class="item-options sort-area drag" v-if="config.sorting_method === 'drag'">
                                <div class="option" v-for="option in options" @mousedown="activeSortingShift(option,$event,options)">{{ option.option_content }}</div>
                            </div>
                        </div>
        ...
        data: {},
        methods: {
            activeSortingShift: function (option, event, options) {
                event.preventDefault();
                event.stopPropagation();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _survey_template_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./survey-template.js */ "./js/swing/survey/survey-template.js");
...
const survey = new Vue({
    ...
    methods: {
        submit: function () {
            ...
            if (could_complete) {
                ...
                for (let i = 0; i < self.answers_object.answers_now.length; i++) {
                    ...
                    delete self.answers_object.answers_now[i].survey_id;
                }
                self.answers_object.answers_now = answers_final;
                self.answers_object.number = parseInt((new Date().getTime() - self.time_begin) / 1000);

                if (self.page_now === self.page) {
                    self.answers_object.status = 'C';
                }

                $.ajax({
                    url: self.realPath + '/survey/answer',
                    type: 'post',
                    dataType: 'json',
                    contentType: 'application/json;charset=utf-8',
                    ...
                    async: true,
                    success: function (d) {
                        self.answers_object.number = '';
                        self.time_begin = new Date().getTime();
        ...
        initialStyle: function (number, style) {
            if (style) {
                $('#root').addClass(style.class_name);
                if (style.config.background) {
                    $('#root').css('background-image', 'url(' + style.config.background + ')');
                }
                if (style.config.color_background) {
                    $('#root').css('background-color', style.config.color_background);
                }
            }
        },
        getData: function (page) {
            ...
            //                 "subBreak": "1",
            //                 "subCollected": "",
            //                 "subConfig": "[{\"exist\":true,\"page_now\":3,\"required\":true,\"neck\":false,\"random_option\":\"fixed\",\"layout\":{\"orientation\":\"horizon\",\"cols_number\":2,\"width_percent\":\"50%\"},\"recommend\":{\"bool\":false,\"recommended\":\"\"},\"page\":1,\"break\":1}]",
            //                 "subId": 105,
            //                 "subIndex": "1",
            //                 "subLogic": [
            //
            ...
            //                 "subName": "你的性别是？",
            //                 "subNumber": "1",
            //                 "subOption": "[{\"option_id\":0,\"option_index\":1,\"option_code\":\"\",\"option_content\":\"男\",\"checked\":false,\"mutex\":false,\"blank\":false,\"code\":\"1\"},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"女\",\"checked\":false,\"mutex\":false,\"blank\":false,\"code\":\"2\"}]",
            //                 "subPId": 0,
            //                 "subPage": "1",
            //                 "subQuestions": [
            //
            ...
            //                 "subBreak": "1",
            //                 "subCollected": "",
            //                 "subConfig": "[{\"exist\":true,\"page_now\":3,\"required\":true,\"neck\":false,\"func_display\":false,\"random_option\":\"random\",\"layout\":{\"orientation\":\"portrait\",\"cols_number\":1,\"width_percent\":\"100%\"},\"recommend\":{\"bool\":false,\"recommended\":\"\"},\"page\":1,\"break\":1}]",
            //                 "subId": 106,
            //                 "subIndex": "1",
            //                 "subLogic": [
            //
            ...
            //                 "subName": "你曾经去过的城市：",
            //                 "subNumber": "2",
            //                 "subOption": "[{\"option_id\":0,\"option_index\":1,\"option_code\":\"\",\"option_content\":\"北京\",\"checked\":false,\"mutex\":false,\"blank\":false},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"上海\",\"checked\":false,\"mutex\":false,\"blank\":false},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"广州\"},{\"option_id\":2,\"option_index\":3,\"option_code\":\"\",\"option_content\":\"深圳\"}]",
            //                 "subPId": 1,
            //                 "subPage": "1",
            //                 "subQuestions": [
            //
            ...
            //             {
            //                 "logic": "[{\"jump\":[],\"display\":[]}]",
            //                 "questions": "[{\"question_id\":0,\"question_index\":1,\"question_content\":\"第一子问题\"},{\"question_id\":1,\"question_index\":2,\"question_content\":\"第二子问题\"}]",
            //                 "siteQuestions": "",
            //                 "subBreak": "1",
            //                 "subCollected": "",
            //                 "subConfig": "[{\"exist\":true,\"page_now\":3,\"required\":true,\"neck\":false,\"the_class\":\"single\",\"func_display\":false,\"layout\":{\"orientation\":\"portrait\",\"cols_number\":1,\"width_percent\":\"100%\"},\"recommend\":{\"bool\":false,\"recommended\":\"\"},\"restrict\":\"none\",\"number\":\"\",\"min_word\":\"\",\"max_word\":\"5\",\"post\":\"先生\",\"page\":1,\"break\":1}]",
            //                 "subId": 107,
            //                 "subIndex": "1",
            //                 "subLogic": [
            //
            ...
            //             {
            //                 "logic": "[{\"jump\":[],\"display\":[]}]",
            //                 "questions": "[{\"question_id\":0,\"question_index\":1,\"the_class\":\"matrix_choice\",\"question_content\":\"苹果\"},{\"question_id\":1,\"question_index\":2,\"the_class\":\"matrix_choice\",\"question_content\":\"三星\"},{\"question_id\":1,\"question_index\":2,\"question_content\":\"华为\"},{\"question_id\":1,\"question_index\":3,\"question_content\":\"中兴\"},{\"question_id\":1,\"question_index\":4,\"question_content\":\"小米\"},{\"question_id\":1,\"question_index\":5,\"question_content\":\"OPPO\"},{\"question_id\":1,\"question_index\":6,\"question_content\":\"其他\"}]",
            //                 "siteQuestions": "",
            //                 "subBreak": "1",
            //                 "subCollected": "",
            //                 "subConfig": "[{\"exist\":true,\"page_now\":3,\"required\":true,\"neck\":false,\"the_class\":\"matrix_choice\",\"func_display\":false,\"layout\":{\"orientation\":\"portrait\",\"cols_number\":1,\"width_percent\":\"100%\"},\"recommend\":{\"bool\":false,\"recommended\":\"\"},\"restrict\":\"none\",\"number\":\"\",\"min_word\":\"\",\"max_word\":\"\",\"post\":\"\",\"random_branch\":\"\",\"random_option_matrix\":\"\",\"page\":1,\"break\":1}]",
            //                 "subId": 108,
            //                 "subIndex": "1",
            //                 "subLogic": [
            //
            //                 ],
            //                 "subName": "您的手机品牌和购买价格分别是",
            //                 "subNumber": "Q1",
            //                 "subOption": "[{\"option_id\":0,\"option_index\":1,\"option_code\":\"\",\"option_content\":\"&lt;1000\"},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"1000~2000\"},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"2000~4000\"},{\"option_id\":2,\"option_index\":3,\"option_code\":\"\",\"option_content\":\"4000~6000\"},{\"option_id\":2,\"option_index\":4,\"option_code\":\"\",\"option_content\":\"6000~10000\"},{\"option_id\":2,\"option_index\":5,\"option_code\":\"\",\"option_content\":\">10000\"}]",
            //                 "subPId": 3,
            //                 "subPage": "1",
            //                 "subQuestions": [
            //
            ...
            //                 "subBreak": "1",
            //                 "subCollected": "",
            //                 "subConfig": "[{\"exist\":true,\"page_now\":3,\"required\":true,\"neck\":false,\"func_display\":false,\"layout\":{\"orientation\":\"horizon\",\"cols_number\":5,\"width_percent\":\"20%\"},\"recommend\":{\"bool\":false,\"recommended\":\"\"},\"style\":\"brick\",\"min_score\":\"\",\"max_score\":\"\",\"credit\":\"satisfaction\",\"left_label\":\"非常不满意\",\"right_label\":\"非常满意\",\"page\":1,\"break\":1}]",
            //                 "subId": 109,
            //                 "subIndex": "2",
            //                 "subLogic": [
            //
            ...
            //                 "subBreak": "1",
            //                 "subCollected": "",
            //                 "subConfig": "[{\"exist\":true,\"page_now\":3,\"required\":true,\"neck\":false,\"func_display\":false,\"layout\":{\"orientation\":\"portrait\",\"cols_number\":1,\"width_percent\":\"100%\"},\"recommend\":{\"bool\":false,\"recommended\":\"\"},\"style\":\"number\",\"sorting_method\":\"drag\",\"min_score\":\"\",\"max_score\":\"\",\"page\":1,\"break\":1}]",
            //                 "subId": 110,
            //                 "subIndex": "3",
            //                 "subLogic": [
            //
            //                 ],
            //                 "subName": "按照下列人员的年龄，从大到小排序",
            //                 "subNumber": "Q3",
            //                 "subOption": "[{\"option_id\":0,\"option_index\":1,\"option_code\":\"\",\"option_content\":\"张燕\",\"checked\":false,\"mutex\":false,\"blank\":false},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"郑纪川\",\"checked\":false,\"mutex\":false,\"blank\":false},{\"option_id\":2,\"option_index\":2,\"option_code\":\"\",\"option_content\":\"李鹏\"},{\"option_id\":2,\"option_index\":3,\"option_code\":\"\",\"option_content\":\"孟志远\"},{\"option_id\":2,\"option_index\":4,\"option_code\":\"\",\"option_content\":\"王向阳\"}]",
            //                 "subPId": 5,
            //                 "subPage": "1",
            //                 "subQuestions": [
            //
        ...
        initialSurvey: function (d) {
            ...
            this.answers_object.survey_id = this.survey_id; //--------------------------------待更改
            this.answers_array = this.answers_object.answers_now;
            _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"].logic = this.logic = information.wjSavedLogic || {
                display_logic: [],
                jump_logic: []
            };
        ...
        renderItem: function (data) {
            let id, sub_id, index, name, remark, number, page, breaking, type, options, sub_questions, config, template, methods, watcher, mounted, created, beforeCreate, answer_container;
            ...
            if (data.subConfig) {
                ...
                if (data.questions) {
                    data.sub_questions = JSON.parse(data.questions);
                }
                page = data.page = parseInt(data.subPage);
                breaking = data.breaking = data.subBreak;
                type = data.type = data.subType;
                data.config = config;
                template = _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"][type].template;
                methods = _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"][type].methods;
                watcher = _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"][type].watch || {};
                beforeCreate = _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"][type].beforeCreate || function () {};
                mounted = _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"][type].mounted || function () {};
                created = _survey_template_js__WEBPACK_IMPORTED_MODULE_0__["default"][type].created || function () {};

                if (data.subOption) {
                    options = data.options = JSON.parse(data.subOption);
                }
                if (data.questions) {
                    sub_questions = data.sub_questions = JSON.parse(data.questions);
                }
                ...
                data.answer.index = data.index;
                data.config.page_now = this.page;
                data.pass = 0;
...
//         pos=curWwwPath.indexOf(pathName),
//         localhostPath=curWwwPath.substring(0,pos);
//     this.realPath=localhostPath+projectName;
//     this.page = 1;
//     this.answers_now = [];
//     this.question_array = [];
//     this.answers_object = {};
...
//             dataType: 'json',
//             contentType: 'application/json;charset=utf-8',
//             data: JSON.stringify(this.answers_object),
//             async: true,
//             success: function(d){
//
//             },
...
//     });
//
//     function initialSurvey(d){
//         self.page_total = d.pageTotal;
//
//         let information = d.wjSurvey[0];
//
//         self.survey_id = information.wjId;
//         self.survey_name = information.wjName;
//         self.survey_number = information.wjNumber;
//         self.survey_remark = information.wjRemark;
//         self.style = information.wjStyle;
//
//         self.questions = d.wjSubject;
//
//         self.answers_object.sub_id = code;
//         self.answers_array = self.answers_now;
//         survey_template.logic = self.logic = information.wjSavedLogic;
//         for (let i = 0; i < self.logic.display_logic.length; i++){
//             for (let j = 0; j < self.logic.display_logic[i].conditions.length; j++){
//                 self.logic.display_logic[i].conditions[j].correspond = false
//             }
//         }
//         for (let i = 0; i < self.logic.jump_logic.length; i++){
//             for (let j = 0; j < self.logic.jump_logic[i].conditions.length; j++){
//                 self.logic.jump_logic[i].conditions[j].correspond = false
//             }
//         }
//
//         displayItem(self.questions)
//     }
//
//     function displayItem(questions){
//         if (questions.length){
//             function compare(obj_a, obj_b){
//                 return parseInt(obj_a['subIndex']) - parseInt(obj_b['subIndex'])
//             }
...
//             answer_container;
//
//         if (data.config.exist){
//             id = data.subPId;
//             sub_id = data.subId;
//             index = data.subIndex;
//             name = data.subName;
//             remark = data.subRemark;
//             number = data.subNumber;
//             breaking = data.subBreak;
//             type = data.subType;
//             config = JSON.parse(data.subConfig);
...
//             data.answer = answer_container;
//             data.pass = false;
//             self.question_array.push(new Vue({
//                 el: '#item-' + index,
//                 data: data,
//                 methods: methods
//             }))
