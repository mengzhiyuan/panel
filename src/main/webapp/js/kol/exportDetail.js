            ...
            $("#result").bootstrapTable('destroy')
                .bootstrapTable({
                    ...
                    responseHandler: function(data){
                        ...
                        for (let i = 0; i < len; i++){
                        	if (!member_list[i]) continue;
                            data.rows.push({
                                id: member_list[i].docId,//编号
                                idLogin: member_list[i].docIdentity,//会员名称
                                province: member_list[i].hosProvince || '',//省份
                                city: member_list[i].hosCity || '',//城市
                                district: member_list[i].hosDistrict || '',//区县
                                name: member_list[i].docName,//姓名
                                source: member_list[i].attriName || '',//数据属性
                                proType: member_list[i].catName || '',//职称类别
                                proClass: member_list[i].levId,//职称级别
                                title: member_list[i].admiName || '',//行政职称
                                department: member_list[i].belongId,//所在科室
                                depType: member_list[i].categName || '',//科室类别
                                depNature: member_list[i].natId,//科室性质
                                profField: member_list[i].specId,//专业领域
                                nameComp: member_list[i].hosName || '',//单位名称
                                level: member_list[i].hoslelId || '',//单位级别
                                grade: member_list[i].hosgraId || '',
                                type: member_list[i].typeId || '',//单位类型
                                profit: member_list[i].profitId || '',//盈利性质
                                property: member_list[i].propertyId || '',//单位属性
