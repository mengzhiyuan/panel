            ...
            success: function(d){
                ...
                for (i = 0; i < len; i++){
                    self.applies.push({
                        ...
                        time: (list[i].createTime.year + 1900) + '-' + (list[i].createTime.month + 1) + '-' + list[i].createTime.date + ' ' +
                            list[i].createTime.hours + ':' + list[i].createTime.minutes + ':' +list[i].createTime.seconds
                    })
                }
            },
            error: function(e){
