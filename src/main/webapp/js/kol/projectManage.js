...
$(function(){
    const data = {
        ...
        eventHandler: {
            ...
            'click .external_btn': function(e, value, row, index){
                sessionStorage.setItem('project_id', row.id);
                location.href = './externalListen.html'
            }
        },
        email_address: [],
        email_title: '',
                    ...
                    columns: [{
                        ...
                        formatter : function(value, row, index) {
                            let a = "<button class=\"btn btn-xs progress_btn\" title=\"项目进度\"><i class=\"glyphicon glyphicon-info-sign\"></i></button>",
                                ...
                                e = "<button disabled class=\"btn btn-xs external_btn\" title=\"外部链接使用情况\"><i class=\"glyphicon glyphicon-comment\"></i></button>";
