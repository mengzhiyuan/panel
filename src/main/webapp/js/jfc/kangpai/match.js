...
$(function(){
                ...
                'click .email_btn': function (e, value, row, index) {
                    if (!row.email){
                        ...
                        let warning = $(`<div class="email-warning" style="position: fixed;
                                                    left:`+ ($(window).height()/2-25 + 'px') +`;
                                                    top:`+ ($(window).width()/2-120 + 'px') +`;
                                                    display: none;
                                                    width: 240px;
                                                    height: 50px;
                                                    line-height: 50px;
    ...
    const methods = {
        ...
        changeConfidentialField: function(f,t){
            $(t).prop('checked') ? this.confidential_checked.push(i) : this.confidential_checked.splice(this.confidential_checked.indexOf(i),1)
        },
        toSetExport: function(){
