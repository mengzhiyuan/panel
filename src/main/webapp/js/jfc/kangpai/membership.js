...
$(function(){
    const data = {
        ...
        quick: {
            options_levId: ['住院医师','DIC住院医师','VCD副主任医师','CD主任医师','药士','初级药师','主管药师','副主任药师','主任药师','技师','主管技师','副主任技师','主任技师','护士','护师','主管护师','副主任护师','主任护师'],
            options_belongId: [ '普通内科', '呼吸科', '心血管内科', '内分泌科', '消化内科', '血液科', '肾脏内科', '神经内科', '过敏与免疫科', '老年科/干部科', '风湿科', '血透室（血液透析中心）',
            ...
            options_specId: ['肿瘤/癌症领域', '心脏器官', '呼吸器官', '运动器官', '消化系统', '内分泌系统', '神经领域', '精神/心理', '肾脏/泌尿系统', '血液',
                '皮肤', '风湿', '眼科', '耳鼻喉', '妇产科', '儿科', '康复护理', '疼痛', '其他'],
            options_participate: [],
            options_membId: [],
            options_display: '',
            data_chunk: {
