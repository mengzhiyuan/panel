        ...
        <div class="inner choice" v-if="type==='choice'">
            ...
            <div class="edit" v-show="editing">
               ...
               <span class="description_label">题目描述: </span>
                ...
                <div class="answers">
                    <div class="input choice" v-for="option in options" :key="option.optionId">
                        <i class="icon" :option_id="option.optionId" @click="deleteOption(option)">*</i>
                ...
                <div class="answers matrix" v-if="form==='row'">
                    <table>
                        ...
                        <tr>
                            <th></th>
                            <th></th>
                            <th class="delete-icon" v-for="option in options" :key="option.optionId"  :option_id="option.optionId" @click="deleteOption(option)">*</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                        ...
                        <tr v-for="question in sub_questions" :key="question.index">
                            <td class="delete-icon" @click="deleteSubQuestion(question)" :question_id="question.index">*</td>
                            <td class="inputs" placeholder="输入子问题" contenteditable="true" :question_id="question.index" @input="editSubQuestion(question)">{{ question.title }}</td>
                            <td v-for="option in options" :key="option.optionId">
                                <input tabindex="-1" :name="question.index" type="checkbox" v-if="the_class==='multi'">
                                <input tabindex="-1" :name="question.index" type="radio" v-if="the_class==='single' || the_class==='score'">
                                <input tabindex="-1" :name="question.index" type="text" v-if="the_class==='blank'">
                            </td>
                        </tr>
                        <tr class="insert">
                            <td></td>
                ...
                <div class="answers matrix" v-if="form==='col'">
                    <table>
                        ...
                        <tr>
                            <th></th>
                            <th></th>
                            <th class="delete-icon" v-for="question in sub_questions" :key="question.index"  :question_id="question.index" @click="deleteSubQuestion(question)">*</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td class="inputs"></td>
                            <td class="inputs" placeholder="输入子问题" contenteditable="true" v-for="question in sub_questions" :key="question.index" :question_id="question.index" @input="editSubQuestion(question)">{{ question.title }}</td>
                            <td class="insert-icon" @click="insertSubQuestion">&</td>
                        </tr>
                        <tr v-for="option in options" :key="option.optionId">
                            <td class="delete-icon" @click="deleteOption(option)" :option_id="option.optionId">*</td>
            ...
            <div class="edit" v-show="editing">
                ...
                <div class="answers score">
                    <div class="input score" v-for="option in options" :key="option.optionId">
                        ...
                        <input :option_id="option.optionId" placeholder="分数" class="score_number" :value="option.score" @input="editScore(option)">
                    </div>
